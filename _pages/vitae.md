...
<div class="row" style="margin-top: -5.5em;">
	<a class="ml-auto mr-2" href="/assets/pdf/long-cv-en.pdf" target="_blank">
						...
						<div class="row">
							{% if content.year %}
								<div class="col-xs-2 cl-sm-2 col-md-auto text-left" style="width: 90px;">
									<span class="badge font-weight-bold darken-1 text-uppercase align-middle" style="width: 90px;">
										{{ content.year }}
									</span>
								</div>
							{% endif %}
							<div class="col-xs-10 cl-sm-10 col-md mt-2 mt-md-0">
								...
								{% endif %}
                                {% if content.location %}
								<h6 class="ml-1 ml-md-4">{{content.location}}</h6>
								{% endif %}
